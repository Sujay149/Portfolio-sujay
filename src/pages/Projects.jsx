...
const FeaturedProject = ({ project }) => {
  return (
    <div className="w-full">
      <div className="border-4 border-black dark:border-white rounded-3xl overflow-hidden bg-white dark:bg-gray-800 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] transition-colors h-full flex flex-col">
        {/* Image Section */}
        <div className="relative overflow-hidden bg-white dark:bg-gray-700 p-2 sm:p-3 h-48 md:h-64 lg:h-80 transition-colors">
          <img 
            src={project.image} 
            alt={project.title}
        ...
        {/* Content Section */}
        <div className="p-4 sm:p-6 md:p-8 bg-white dark:bg-gray-800 transition-colors flex-grow flex flex-col">
          <p className="text-pink-500 dark:text-pink-400 font-semibold text-xs sm:text-sm mb-2 transition-colors">{project.category}</p>
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-black dark:text-white mb-3 sm:mb-4 transition-colors">
            {project.title}
          </h3>
          <p className="text-gray-700 dark:text-gray-300 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6 transition-colors flex-grow">
            {project.description}
          </p>
...
const Projects = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black pt-0 transition-colors duration-300">
      <div className="w-full px-2 sm:px-4 md:px-6 lg:px-12 py-20">
        {/* Main Heading */}
        <div className="text-center mb-20 pt-[50px] px-2">
          <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black text-black dark:text-white leading-[1.02] tracking-tight transition-colors">
